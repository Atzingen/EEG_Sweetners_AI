...
def le_dados_EEG(path):
    ...
    ----------
    path : str
        Path to the folder contaning the data of all persons
        Data must be divided in folders named after the experiment day in the format day.month. Every filename must have the format: "nameofthevoluntere+drinkcode_data.txt and must have tree coluns (time, chanel1, chanel2)"
        Exempl2: "/your_folder/"
    Returns
    -------
    dict
        A dictionay in wich:
        key = Name of the voluntere + drink code
        value = list of the available data in 3 coluns (time, chanel1, chanel2)
    """
