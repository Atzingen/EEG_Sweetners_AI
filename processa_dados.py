...
def arredonda_predicao(value, threshold=0.5):
    """Round the decimal value of the prediction to 0 or 1 given a threshold

    Parameters
    ----------
    val : float
        output value of a given predition
    lim : float, optional
        rounding limit with default of 0.5

    Returns
    -------
    int
        output value for a given prediction
    """
