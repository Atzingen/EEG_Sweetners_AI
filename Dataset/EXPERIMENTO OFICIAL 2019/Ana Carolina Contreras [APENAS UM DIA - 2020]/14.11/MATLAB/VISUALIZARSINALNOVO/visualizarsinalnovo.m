...
anacarolinaagua30= load ('anacarolinaagua30_data.txt'); %acucar1

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=anacarolinaagua30(1:m,2);
c4=anacarolinaagua30(1:m,3);
c3c4=(c3-c4);
smin=min(c3c4);
smax=max(c3c4);
sinal=(c3c4-smin*ones(size(c3c4)))/(smax-smin);

save anacarolinaagua30_data.txt sinal -ascii
...
savefig('anacarolinaagua30_data.fig');
