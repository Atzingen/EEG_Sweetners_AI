...
orlandoagua32= load ('orlandoagua32_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=orlandoagua32(1:m,2);
c4=orlandoagua32(1:m,3);
sinal=(c3-c4);
save orlandoagua32_data.txt sinal -ascii
...
savefig('orlandoagua32_data.fig');
