...
orlandoagua34= load ('orlandoagua34_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=orlandoagua34(1:m,2);
c4=orlandoagua34(1:m,3);
sinal=(c3-c4);
save orlandoagua34_data.txt sinal -ascii
...
savefig('orlandoagua34_data.fig');
