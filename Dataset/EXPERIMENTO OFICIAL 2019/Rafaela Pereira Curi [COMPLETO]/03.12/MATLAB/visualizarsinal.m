...
rafacuriagua46= load ('rafacuriagua46_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=rafacuriagua46(1:m,2);
c4=rafacuriagua46(1:m,3);
sinal=(c3-c4);
save rafacuriagua46_data.txt sinal -ascii
...
savefig('rafacuriagua46_data.fig');
