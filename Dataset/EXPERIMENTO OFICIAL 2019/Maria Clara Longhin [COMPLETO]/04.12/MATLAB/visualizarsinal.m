...
mariaclaraagua54= load ('mariaclaraagua54_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=mariaclaraagua54(1:m,2);
c4=mariaclaraagua54(1:m,3);
sinal=(c3-c4);
save mariaclaraagua54_data.txt sinal -ascii
...
savefig('mariaclaraagua54_data.fig');
