...
carolmonicaagua22= load ('carolmonicaagua22_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=carolmonicaagua22(1:m,2);
c4=carolmonicaagua22(1:m,3);
sinal=(c3-c4);
save carolmonicaagua22_data.txt sinal -ascii
...
savefig('carolmonicaagua22_data.fig');
