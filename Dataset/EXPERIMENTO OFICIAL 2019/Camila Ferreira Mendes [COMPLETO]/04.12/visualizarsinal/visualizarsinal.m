...
camilamendesagua55= load ('camilamendesagua55_data.txt');

Ts=1/Fs;
t_final=(m-1)*Ts;
t=0:Ts:t_final;

c3=camilamendesagua55(1:m,2);
c4=camilamendesagua55(1:m,3);
sinal=(c3-c4);
save camilamendesagua55_data.txt sinal -ascii
...
savefig('camilamendesagua55_data.fig');
